...
<div class="hero">
  <h1>Q-Signal</h1>
  <p style="color: #666; font-size: 1.3em; margin-top: 10px;">Q-gesteuert. Echtzeit. Ohne Setup. Nur Profit.</p>
</div>
...
<div style="text-align: center;">
  ...
  <div class="gallery-grid">
    <img src="images/chart1.jpg" alt="Sie arbeiten" title="Sie arbeiten, nicht kämpfen." style="background: linear-gradient(135deg, #667eea, #764ba2);">
    <img src="images/chart2.jpg" alt="Ruhe ist keine Schwäche" title="Ruhe ist keine Schwäche – sie ist Ihre Waffe." style="background: linear-gradient(135deg, #ff6b35, #f7931e);">
    <img src="images/chart3.jpg" alt="Kein Multitasking. Nur Fokus. Und Ergebnis." title="Kein Multitasking. Nur Fokus. Und Ergebnis." style="background: linear-gradient(135deg, #764ba2, #667eea);">
    <img src="images/chart4.jpg" alt="Die beste Strategie atmet langsam." title="Die beste Strategie atmet langsam." style="background: linear-gradient(135deg, #00ff88, #00cc6a);">
    <img src="images/chart5.jpg" alt="Sie schlafen gut" title="Sie schlafen gut – auch nach Volatilität." style="background: linear-gradient(135deg, #ff4757, #ff3838);">
    <img src="images/chart6.jpg" alt="Erfolg braucht keine Hektik." title="Erfolg braucht keine Hektik." style="background: linear-gradient(135deg, #f7931e, #ff6b35);">
  </div>
</div>
...
function updateCTAButton() {
  ...
  if (ctaLink && userData.token) {
    ...
    const baseUrl = 'https://shop.crypto-pilot.space/track/index.php';
